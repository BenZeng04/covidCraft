...
public class Kitchen extends GameplayRoom
{
    public Kitchen()
    {
        ...
        addHitBox(new StorageUnit(0, 20, 170, 110, 390, 0)); // Fridge
        addHitBox(new StorageUnit(0, 110, 80, 230, 230, 1)); // Cabinet
        addHitBox(new StorageUnit(0, 120, 290, 220, 390, 2)); // Sink Cabinet
        addHitBox(new HitBox(0, 230, 220, 650, 390)); // Other furniture
        addHitBox(new StorageUnit(0, 750, 500, 960, 665, 3)); // Cabinets at bottom of screen
