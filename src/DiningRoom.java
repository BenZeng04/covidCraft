...
public class DiningRoom extends GameplayRoom
{
    public DiningRoom()
    {
        ...
        addHitBox(new StorageUnit(0, 150, 230, 240, 350, 0)); //drawer beside bookshelf
        addHitBox(new StorageUnit(0, 240, 110, 420, 350, 1)); //bookshelf
        addHitBox(new StorageUnit(0, 420, 80, 670, 350, 2)); //display case
